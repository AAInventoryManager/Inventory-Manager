# Inventory Manager: Phase 1 Implementation Guide (v5 — Security Hardened)
...
| Cross-tenant FK validation | Trigger enforced | category_id, location_id, item_id must reference same company |
...
| Cross-tenant FK validation | Triggers validate category_id, location_id, item_id belong to same company |
...
-- Ensures category_id, location_id, item_id reference rows in SAME company
