# Inventory Manager: Phase 1 Implementation Guide (v4 — Security Hardened)
...
| company_id immutability | Trigger on ALL tables | Prevents cross-tenant data movement |
...
| company_id immutable | Trigger on ALL tables prevents changing company_id |
